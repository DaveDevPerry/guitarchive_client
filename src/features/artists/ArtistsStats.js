...
import ArtistsStat from './ArtistsStat';

const ArtistsStats = ({ theme }) => {
	const { artistsStats } = useSongsContext();
	...
	return (
		...
		>
			...
			<div className='stats-container'>
				...
				>
					{artistsStats &&
						artistsStats.map((stat, index) => (
							<ArtistsStat key={index} stat={stat} />
						))}
				</div>
			</div>
		</StyledSongStatusStats>
