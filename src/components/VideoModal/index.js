...
const VideoModal = ({ handleClose, youtubeData, theme, handleSnooze }) => {
	...
	const handleClick = async (e) => {
		...
		const updateTarget = clonedTargetArr[2].data.map((obj) => {
			if (obj.target === targetVideoCount) {
				log(obj, targetVideoCount, 'obj to update');
				obj.isComplete = true;
				...
				<div className='congrats-container'>
					...
					<div className='congrats-wrapper'>
						...
						<p className='congrats-figure'>
							<Counter from={0} to={targetVideoCount} time={6} />
						</p>
						{/* <p className='congrats-figure'>
